package cn.ecomb.joy.support.exception;

import cn.ecomb.joy.support.ResponseBody;
import cn.ecomb.joy.support.exception.custom.ModuleException;
import cn.ecomb.joy.support.exception.custom.ServiceException;
import cn.ecomb.joy.support.exception.custom.ValidationException;
import cn.ecomb.joy.support.exception.custom.WebException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ResponseBody> handleAllExceptions(final Exception ex, final WebRequest req) throws Exception {
    ...
    public ResponseEntity<ResponseBody> handleServiceException(final ServiceException ex, final WebRequest req)
            throws Exception {
    ...
    public ResponseEntity<ResponseBody> handleWebException(final WebException ex, final WebRequest req)
            throws Exception {
    ...
    public ResponseEntity<ResponseBody> handleValidationException(final ValidationException ex, final WebRequest req)
            throws Exception {
    ...
    public ResponseEntity<ResponseBody> handleModuleException(final ModuleException ex, final WebRequest req)
            throws Exception {
    ...
    public ResponseEntity<ResponseBody> MethodArgumentNotValidHandler(HttpServletRequest request,
